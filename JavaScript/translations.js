document.addEventListener("DOMContentLoaded", function() {
    const translations = {
        en: {
            ...
            t_route_points_header: "Rank Ups",
            t_route_points_info: "For each of your flight, in which you you flew one of the given routes with one of the given aircrafts and one of the airline from the Lufthansa group and logged it in ",
            t_route_points_info2: "our Discord server",
            t_route_points_info3: " you will get a flight. You can also see yours and others logged flights and how many flights they have in ",
            t_route_points_info4: "our Discord server",
            t_route_points_roles: "Depending on how much flights you have, you will get other roles on our discord server. This are the roles and how much flights you need for them:",
        ...
        de: {
            ...
            t_route_points_header: "Beförderungen",
            t_route_points_info: "Für jeden deiner Flüge, bei dem du eine der vorgegebenen Routen mit einem der angegebenen Flugzeuge und einer der Airlines der Lufthansa-Gruppe geflogen bist und ihn in",
            t_route_points_info2: "unserem Discord-Server",
            t_route_points_info3: " protokolliert hast, erhältst du einen Flug. Du kannst auch deine und die von anderen protokollierten Flüge sowie die Anzahl der Flüge in ",
            t_route_points_info4: "unserem Discord-Server sehen",
            t_route_points_roles: "Je nachdem, wie viele Flüge du hast, erhältst du unterschiedliche Rollen auf unserem Discord-Server. Dies sind die Rollen und die Anzahl der Flüge, die du dafür benötigst:",
        ...
        fr: {
            ...
            t_route_points_header: "Montées en grade",  
            t_route_points_info: "Pour chacun de vos vols, où vous avez effectué l'une des routes données avec l'un des avions spécifiés et une compagnie aérienne du groupe Lufthansa, et que vous l'avez enregistré dans ",  
            t_route_points_info2: "notre serveur Discord",  
            t_route_points_info3: " vous recevrez un vol. Vous pouvez également voir vos vols enregistrés ainsi que ceux des autres et combien de vols ils ont dans ",  
            t_route_points_info4: "notre serveur Discord",  
            t_route_points_roles: "Selon le nombre de vols que vous avez, vous obtiendrez différents rôles sur notre serveur Discord. Voici les rôles et le nombre de vols nécessaires pour les obtenir:",  
        ...
        es: {
            ...
            t_route_points_header: "Ascensos de rango",  
            t_route_points_info: "Por cada uno de tus vuelos, en los que hayas volado una de las rutas dadas con una de las aeronaves especificadas y una de las aerolíneas del grupo Lufthansa, y lo hayas registrado en ",  
            t_route_points_info2: "nuestro servidor de Discord",  
            t_route_points_info3: " recibirás un vuelo. También puedes ver tus vuelos registrados y los de otros, así como cuántos vuelos tienen en ",  
            t_route_points_info4: "nuestro servidor de Discord",  
            t_route_points_roles: "Dependiendo de la cantidad de vuelos que tengas, recibirás diferentes roles en nuestro servidor de Discord. Estos son los roles y la cantidad de vuelos necesarios para cada uno:",
        ...
        ru: {
            ...
            t_route_points_header: "Повышения в ранге",  
            t_route_points_info: "За каждый ваш полёт, который вы совершили по заданному маршруту на одном из указанных самолётов и с одной из авиакомпаний группы Lufthansa, и записали его в ",  
            t_route_points_info2: "наш Discord-сервер",  
            t_route_points_info3: " вы получите зачётный полёт. Вы также можете видеть свои зарегистрированные полёты, а также полёты других участников и их количество в ",  
            t_route_points_info4: "нашем Discord-сервере",  
            t_route_points_roles: "В зависимости от количества ваших полётов, вы получите разные роли на нашем Discord-сервере. Вот роли и количество полётов, необходимых для их получения:",  
